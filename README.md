...
- **Blockchain Micropayments** — Building payment systems on a Layer 1 chain
- **Algorand TypeScript** — Writing smart contracts in TypeScript (compiled to TEAL)
- **State Management** — Using Global State and Local State in Algorand contracts
- **Inner Transactions** — Automated fund distribution via contract-initiated payments
- **NFT Creation** — Minting Algorand Standard Assets (ASAs) from smart contracts
- **Revenue Sharing** — On-chain configurable payment splitting
- **Wallet Integration** — Connecting real wallets (Pera/Defly) via WalletConnect
- **On-Chain Verification** — Querying and proving blockchain state
- **SPA Architecture** — Building multi-page apps without frameworks
- **Embeddable Widgets** — Creating self-contained JavaScript components

### Real-World Impact

TipJar demonstrates how blockchain can empower content creators with direct monetization — instant payments, sub-cent fees, full transparency, and no intermediaries. Algorand's ~3.3 second finality and ~$0.001 transaction cost makes micropayments practical compared to traditional platforms charging 10-30%.
...
- [Algorand Foundation](https://algorand.foundation/) — Blockchain platform
- [AlgoKit](https://developer.algorand.org/algokit/) — Development toolkit
- [Puya-TS](https://github.com/algorandfoundation/puya-ts) — TypeScript-to-TEAL compiler
- [Pera Wallet](https://perawallet.app/) — Mobile wallet SDK
- [Defly Wallet](https://defly.app/) — Mobile wallet SDK
- [Algonode](https://algonode.io/) — Free Algorand API endpoints
- [AlgoKit Utils](https://github.com/algorandfoundation/algokit-utils-ts) — Algorand utility library
